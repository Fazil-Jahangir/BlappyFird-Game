...
public class MenuPane extends GraphicsPane {
	...
	private GButton newGame = new GButton("Start Game", (program.WINDOW_WIDTH/2)-58, 200, MainApplication.BUTTON_HEIGHT,
	...
	public MenuPane(MainApplication app) {
		program = app;
		for (int i = 0; i <= 3; i++) {
			GButton button = new GButton(gbuttonStrings[i], (program.WINDOW_WIDTH/2)-58, 270 + 70 * i, program.BUTTON_HEIGHT,
					program.BUTTON_WIDTH);
