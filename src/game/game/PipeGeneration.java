...
/**
 * PipeGeneration class is a class that will handle generating pipe imaging, spawning, and movement. Essentially this class will handle the behavior of the pipes.
 * TODO
 * -Remove any unnecessary code in this class (if any) 
...
public class PipeGeneration extends GraphicsProgram {
	...
	/*
	 * Method will move the pipes to left. Pipespeed will determine the speed of the pipe's movements. If the speed is not desired, change the value
	 * of pipespeed. The higher the number, the faster of the movement
	 * TODO
